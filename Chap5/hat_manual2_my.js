...
var _t_mat_view = mat4();
var _r_mat_view = mat4();
var _t_mat_model= mat4();
var _r_mat_model= mat4();
...
// (two triangles/quad) from data
	...
	var lable_view_yaw = document.getElementById("lable_view_yaw");
	var lable_view_pitch = document.getElementById("lable_view_pitch");
	var lable_view_roll = document.getElementById("lable_view_roll");
	var lable_model_yaw = document.getElementById("lable_model_yaw");
	var lable_model_pitch = document.getElementById("lable_model_pitch");
	var lable_model_roll = document.getElementById("lable_model_roll");
	var lable_mp = document.getElementById("lable_mp");
	var lable_vp = document.getElementById("lable_vp");
	
	lable_view_yaw.innerText = " " + _yaw_view;
	lable_view_roll.innerText = " " + _roll_view;
	lable_view_pitch.innerText = " " + _pitch_view;
	lable_model_yaw.innerText = " " + _yaw_model;
	lable_model_roll.innerText = " " + _roll_model;
	lable_model_pitch.innerText = " " + _pitch_model;
	...
	document.getElementById("btn_m_left").onclick = function(){
		_t_mat_model = mult(_t_mat_model, translate(-1, 0, 0 ));
		_m_pos = add(_m_pos, vec4(-1, 0, 0, 0));
		lable_mp.innerText = "m:("+_m_pos[0]+", "+_m_pos[1]+", "+_m_pos[2]+")";
	};
	document.getElementById("btn_m_up").onclick = function(){
		_t_mat_model = mult(_t_mat_model, translate(0, 1, 0 ));
	...
	document.getElementById("btn_m_far").onclick = function(){
		_t_mat_model = mult(_t_mat_model, translate(0, 0, -1 ));
	...
	document.getElementById("btn_v_left").onclick = function(){
		_t_mat_view = mult(translate(1, 0, 0 ), _t_mat_view);
		_v_pos = add(_v_pos, vec4(1, 0, 0, 0));
		lable_vp.innerText = "v:("+_v_pos[0]+", "+_v_pos[1]+", "+_v_pos[2]+")";
	};
	document.getElementById("btn_v_up").onclick = function(){
		_t_mat_view = mult(translate(0, 1, 0 ), _t_mat_view);
	...
	document.getElementById("btn_v_far").onclick = function(){
		_t_mat_view = mult(translate(0, 0, -1 ), _t_mat_view);
	...
	document.getElementById("btn_view_yaw_in").onclick = function(){
		_r_mat_view = mult(rotateY(1), _r_mat_view);
		_yaw_view += 1;
		lable_view_yaw.innerText = " " + _yaw_view;
	};
	document.getElementById("btn_view_yaw_de").onclick = function(){
		_r_mat_view = mult(rotateY(-1), _r_mat_view);
		_yaw_view -= 1;
		lable_view_yaw.innerText = " " + _yaw_view;
	};

	document.getElementById("btn_view_pitch_in").onclick = function(){
		_r_mat_view = mult(rotateX(1), _r_mat_view);
		_pitch_view += 1;
		lable_view_pitch.innerText = " " + _pitch_view;
	};
	document.getElementById("btn_view_pitch_de").onclick = function(){
		_r_mat_view = mult(rotateX(-1), _r_mat_view);
		_pitch_view -= 1;
		lable_view_pitch.innerText = " " + _pitch_view;
	};

	document.getElementById("btn_view_roll_in").onclick = function(){
		_r_mat_view = mult(rotateZ(1), _r_mat_view);
		_roll_view += 1;
		lable_view_roll.innerText = " " + _roll_view;
	};
	document.getElementById("btn_view_roll_de").onclick = function(){
		_r_mat_view = mult(rotateZ(-1), _r_mat_view);
		_roll_view -= 1;
		lable_view_roll.innerText = " " + _roll_view;
	};
	...
	document.getElementById("btn_model_yaw_in").onclick = function(){
		_r_mat_model = mult(rotateY(1), _r_mat_model);
		_yaw_model += 1;
		lable_model_yaw.innerText = " " + _yaw_model;
	};
	document.getElementById("btn_model_yaw_de").onclick = function(){
		_r_mat_model = mult(rotateY(-1), _r_mat_model);
		_yaw_model -= 1;
		lable_model_yaw.innerText = " " + _yaw_model;
	};
	document.getElementById("btn_model_pitch_in").onclick = function(){
		_r_mat_model = mult(rotateX(1), _r_mat_model);
		_pitch_model += 1;
		lable_model_pitch.innerText = " " + _pitch_model;
	};
	document.getElementById("btn_model_pitch_de").onclick = function(){
		_r_mat_model = mult(rotateX(-1), _r_mat_model);
		_pitch_model -= 1;
		lable_model_pitch.innerText = " " + _pitch_model;
	};
	document.getElementById("btn_model_roll_in").onclick = function(){
		_r_mat_model = mult(rotateZ(1), _r_mat_model);
		_roll_model += 1;
		lable_model_roll.innerText = " " + _roll_model;
	};
	document.getElementById("btn_model_roll_de").onclick = function(){
		_r_mat_model = mult(rotateZ(-1), _r_mat_model);
		_roll_model -= 1;
		lable_model_roll.innerText = " " + _roll_model;
	};
...
function render()
{
    ...
    var v_mat = mult(_t_mat_view, _r_mat_view);
    var m_mat = mult(_r_mat_model, _t_mat_model);
    var vm_mat = mult(v_mat, m_mat);


    gl.uniformMatrix4fv( viewMatrixLoc, false, flatten(vm_mat) );
